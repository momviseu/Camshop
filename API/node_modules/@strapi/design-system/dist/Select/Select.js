...
`, Z = (we) => {
  ...
  const a = Be("select", i), [y, g] = ae(void 0), M = Se(y), k = pe(null), I = `${a}-label`, v = `${a}-content`, j = typeof E == "string";
  let S;
  if (j ? S = `${a}-error` : C && (S = `${a}-hint`), b && !p)
  ...
  const q = (t, c) => {
    ...
    return u && (b ? _.push({ label: t.props.children, value: t.props.value }) : $ = t.props.children), K(t, {
      id: Y(d),
      onClick: () => x(t.props.value),
      selected: u,
      multi: p,
      isChild: c
    });
  ...
  return /* @__PURE__ */ r.createElement(he, {
  ...
  }, /* @__PURE__ */ r.createElement(R, null, L && /* @__PURE__ */ r.createElement(U, {
    paddingLeft: 3,
    "aria-hidden": !0
  }, L), b && /* @__PURE__ */ r.createElement($e, {
    tags: _,
    onRemoveTag: x,
    disabled: m
    ...
    as: "span",
    id: v
  }, h ? h(n) : $ || O, n.join(", "))) : /* @__PURE__ */ r.createElement(Q, {
    ellipsis: !0,
    id: v,
    textColor: n ? "neutral800" : "neutral600"
  }, h ? h(n) : $ || O, p && /* @__PURE__ */ r.createElement(X, {
    as: "span"
  }, n.join(", "))))), /* @__PURE__ */ r.createElement(R, null, (p && n && n.length || !p && n) && D && /* @__PURE__ */ r.createElement(Ce, {
    as: "button",
    type: "button",
    onClick: ie,
    "aria-label": w,
    ...
    selectId: a,
    labelledBy: o ? I : void 0,
    onEscape: ne,
    expanded: y,
    onSelectItem: (t, c) => c ? P(t) : x(t, !1),
    multi: p
  }, le)));
};
Z.defaultProps = {
